...
Egyetlen listában átfuthatod az összes [link=https://kritikustomeg.org/folytatas/17/james-bond-filmek]James Bond-filmet[/link] vagy [link=https://kritikustomeg.org/folytatas/107/stephen-king-feldolgozasok]Stephen King adaptációt[/link]. Az összetett keresőben megtalálhatod [link=https://kritikustomeg.org/osszetett_kereso/?o=-number_of_ratings&director=Steven%20Spielberg&actor=Tom%20Hanks]rendezők és színészek[/link] vagy [link=https://kritikustomeg.org/osszetett_kereso/?o=-number_of_ratings&actor=Harvey%20Keitel,%20Steve%20Buscemi]színészek és színészek[/link] közös filmjeit, vagy akár a [link=https://kritikustomeg.org/osszetett_kereso/?o=-number_of_ratings&avg_rating_min=4&avg_rating_max=&keyword=maffia&year=1970-1979]70-es évek, legalább 4-es átlagú maffiával foglalkozó filmjeit[/link] (ez csak egy példa).

A fentieknél is fontosabb, hogy végre választ kaphatsz a kérdésre: [b]mit nézzek meg ma este?[/b]

Ha mozizni szeretsz, fusd át az [link=https://kritikustomeg.org/bemutatok/]aktuális bemutatókat[/link]. Ha nem akarsz sokat töprengeni, válaszd a [link=https://kritikustomeg.org/napok_filmjei/]nap filmjét[/link]. A hét minden napjára más logika szerint ajánlunk filmet: néha különlegesebbet, néha mainstream-ebbet, de mindenképp kiválót.

Ha viszont pont, hogy szívesen szemezgetsz, böngéssz a toplistákban: nem csak [link=https://kritikustomeg.org/top_filmek/]minden idők legjobb filmjeit[/link] találod itt, hanem [link=https://kritikustomeg.org/top_filmek/?tipus=legjobb&ev=2010]korszak[/link], [link=https://kritikustomeg.org/top_filmek/?tipus=legjobb&orszag=magyar]ország[/link] és [link=https://kritikustomeg.org/top_filmek/?tipus=legjobb&mufaj=akciofilm]műfaj[/link] szerint is szűrhetsz. Ha különlegességre vágysz, ott vannak az [link=https://kritikustomeg.org/top_filmek/?tipus=ismeretlen]ismeretlen gyöngyszemek[/link], ha egy kis önkínzásra, a [link=https://kritikustomeg.org/top_filmek/?tipus=legrosszabb]legrosszabb filmek[/link], ha pedig a "lemaradásodat" akarod behozni, a [link=https://kritikustomeg.org/top_filmek/?tipus=legnezettebb]legnépszerűbb filmek[/link]. És végül ott vannak még a [link=https://kritikustomeg.org/felhasznaloi_toplistak/]felhasználói toplisták[/link], köztük félkövérrel kiemelve, ahol nem csak egy listát találsz, hanem magyarázatot is hozzá.
...
<p>Ahhoz, hogy ténylegesen módosuljon az email címed, kattints erre a linkre:</p>
<p><a href="{verification_url}" style="text-decoration: none; color: rgb(27,117,174)">{verification_url}</a></p>'''
...
Ez egy hivatalos figyelmeztetés a szerkesztőségtől. Ha továbbra sem tartod be a [link=https://kritikustomeg.org/szabalyzat/]szabályzatot[/link], a következő retorzió egy ideiglenes kitiltás lesz. Hadd ne kelljen idáig eljutni.
