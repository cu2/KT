...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KTUser.is_admin'
        db.add_column(u'ktapp_ktuser', 'is_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KTUser.is_admin'
        db.delete_column(u'ktapp_ktuser', 'is_admin')
    ...
    models = {
        ...
        u'ktapp.pollchoice': {
            'Meta': {'ordering': "['poll', 'serial_number']", 'object_name': 'PollChoice'},
