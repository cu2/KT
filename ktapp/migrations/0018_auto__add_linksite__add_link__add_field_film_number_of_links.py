...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.number_of_links'
        db.add_column(u'ktapp_film', 'number_of_links',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.number_of_links'
        db.delete_column(u'ktapp_film', 'number_of_links')
