...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ktapp_topic', (
            ...
            ('last_comment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_topic_comment', null=True, to=orm['ktapp.Comment'])),
        ))
        ...
        db.create_table(u'ktapp_comment', (
            ...
            ('reply_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.Comment'], null=True, blank=True)),
        ))
        db.send_create_signal(u'ktapp', ['Comment'])

        # Adding field 'Film.last_comment'
        db.add_column(u'ktapp_film', 'last_comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_film_comment', null=True, to=orm['ktapp.Comment']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.last_comment'
        db.delete_column(u'ktapp_film', 'last_comment_id')
    ...
    models = {
        ...
        u'ktapp.comment': {
            ...
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ktapp.Comment']", 'null': 'True', 'blank': 'True'}),
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ktapp.Topic']", 'null': 'True', 'blank': 'True'})
        },
        u'ktapp.film': {
            'Meta': {'object_name': 'Film'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_comment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'last_film_comment'", 'null': 'True', 'to': u"orm['ktapp.Comment']"}),
        ...
        u'ktapp.topic': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_comment': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'last_topic_comment'", 'null': 'True', 'to': u"orm['ktapp.Comment']"}),
