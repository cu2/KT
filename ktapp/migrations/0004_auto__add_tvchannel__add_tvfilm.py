...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ktapp_tvchannel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'ktapp', ['TVChannel'])

        # Adding model 'TVFilm'
        db.create_table(u'ktapp_tvfilm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.Film'], null=True, blank=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.TVChannel'], null=True, blank=True)),
        ...
        db.send_create_signal(u'ktapp', ['TVFilm'])


    def backwards(self, orm):
        # Deleting model 'TVChannel'
        db.delete_table(u'ktapp_tvchannel')

        # Deleting model 'TVFilm'
        db.delete_table(u'ktapp_tvfilm')
