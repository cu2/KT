...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.number_of_keywords'
        db.add_column(u'ktapp_film', 'number_of_keywords',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.number_of_keywords'
        db.delete_column(u'ktapp_film', 'number_of_keywords')
