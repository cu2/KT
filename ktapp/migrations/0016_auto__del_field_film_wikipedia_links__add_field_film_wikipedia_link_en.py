...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.wikipedia_link_en'
        db.add_column(u'ktapp_film', 'wikipedia_link_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Film.wikipedia_link_hu'
        db.add_column(u'ktapp_film', 'wikipedia_link_hu',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.wikipedia_link_en'
        db.delete_column(u'ktapp_film', 'wikipedia_link_en')

        # Deleting field 'Film.wikipedia_link_hu'
        db.delete_column(u'ktapp_film', 'wikipedia_link_hu')
