...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ktapp_wishlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.Film'], null=True, blank=True)),
            ('wished_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.KTUser'], null=True, blank=True)),
            ('wished_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('wish_type', self.gf('django.db.models.fields.CharField')(default='Y', max_length=1)),
        ))
        db.send_create_signal(u'ktapp', ['Wishlist'])


    def backwards(self, orm):
        # Deleting model 'Wishlist'
        db.delete_table(u'ktapp_wishlist')
