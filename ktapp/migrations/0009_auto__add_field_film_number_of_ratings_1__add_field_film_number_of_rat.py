...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.number_of_ratings_1'
        db.add_column(u'ktapp_film', 'number_of_ratings_1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Film.number_of_ratings_2'
        db.add_column(u'ktapp_film', 'number_of_ratings_2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Film.number_of_ratings_3'
        db.add_column(u'ktapp_film', 'number_of_ratings_3',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Film.number_of_ratings_4'
        db.add_column(u'ktapp_film', 'number_of_ratings_4',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Film.number_of_ratings_5'
        db.add_column(u'ktapp_film', 'number_of_ratings_5',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.number_of_ratings_1'
        db.delete_column(u'ktapp_film', 'number_of_ratings_1')

        # Deleting field 'Film.number_of_ratings_2'
        db.delete_column(u'ktapp_film', 'number_of_ratings_2')

        # Deleting field 'Film.number_of_ratings_3'
        db.delete_column(u'ktapp_film', 'number_of_ratings_3')

        # Deleting field 'Film.number_of_ratings_4'
        db.delete_column(u'ktapp_film', 'number_of_ratings_4')

        # Deleting field 'Film.number_of_ratings_5'
        db.delete_column(u'ktapp_film', 'number_of_ratings_5')
