...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FilmArtistRelationship.role_name'
        db.alter_column(u'ktapp_filmartistrelationship', 'role_name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Keyword.name'
        db.alter_column(u'ktapp_keyword', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Poll.title'
        db.alter_column(u'ktapp_poll', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'PremierType.name'
        db.alter_column(u'ktapp_premiertype', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Artist.name'
        db.alter_column(u'ktapp_artist', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Topic.title'
        db.alter_column(u'ktapp_topic', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Film.orig_title'
        db.alter_column(u'ktapp_film', 'orig_title', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Film.wikipedia_link_hu'
        db.alter_column(u'ktapp_film', 'wikipedia_link_hu', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Film.wikipedia_link_en'
        db.alter_column(u'ktapp_film', 'wikipedia_link_en', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'FilmArtistRelationship.role_name'
        db.alter_column(u'ktapp_filmartistrelationship', 'role_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Keyword.name'
        db.alter_column(u'ktapp_keyword', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Poll.title'
        db.alter_column(u'ktapp_poll', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'PremierType.name'
        db.alter_column(u'ktapp_premiertype', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Artist.name'
        db.alter_column(u'ktapp_artist', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Topic.title'
        db.alter_column(u'ktapp_topic', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Film.orig_title'
        db.alter_column(u'ktapp_film', 'orig_title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Film.wikipedia_link_hu'
        db.alter_column(u'ktapp_film', 'wikipedia_link_hu', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Film.wikipedia_link_en'
        db.alter_column(u'ktapp_film', 'wikipedia_link_en', self.gf('django.db.models.fields.CharField')(max_length=200))
