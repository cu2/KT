...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.imdb_link'
        db.add_column(u'ktapp_film', 'imdb_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Film.porthu_link'
        db.add_column(u'ktapp_film', 'porthu_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'Film.wikipedia_links'
        db.add_column(u'ktapp_film', 'wikipedia_links',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Film.imdb_rating'
        db.add_column(u'ktapp_film', 'imdb_rating',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Film.imdb_rating_refreshed_at'
        db.add_column(u'ktapp_film', 'imdb_rating_refreshed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.imdb_link'
        db.delete_column(u'ktapp_film', 'imdb_link')

        # Deleting field 'Film.porthu_link'
        db.delete_column(u'ktapp_film', 'porthu_link')

        # Deleting field 'Film.wikipedia_links'
        db.delete_column(u'ktapp_film', 'wikipedia_links')

        # Deleting field 'Film.imdb_rating'
        db.delete_column(u'ktapp_film', 'imdb_rating')

        # Deleting field 'Film.imdb_rating_refreshed_at'
        db.delete_column(u'ktapp_film', 'imdb_rating_refreshed_at')
    ...
    models = {
        ...
        u'ktapp.film': {
            ...
            'wikipedia_links': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
