...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ktapp_pollchoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.Poll'])),
        ...
        db.send_create_signal(u'ktapp', ['PollChoice'])

        # Adding model 'PollVote'
        db.create_table(u'ktapp_pollvote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.KTUser'], null=True, blank=True)),
            ('pollchoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.PollChoice'])),
        ))
        db.send_create_signal(u'ktapp', ['PollVote'])

        # Adding unique constraint on 'PollVote', fields ['user', 'pollchoice']
        db.create_unique(u'ktapp_pollvote', ['user_id', 'pollchoice_id'])

        # Adding field 'Poll.created_by'
        db.add_column(u'ktapp_poll', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ktapp.KTUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poll.created_at'
        db.add_column(u'ktapp_poll', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 16, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Poll.nominated_by'
        db.add_column(u'ktapp_poll', 'nominated_by',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poll.open_from'
        db.add_column(u'ktapp_poll', 'open_from',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poll.open_until'
        db.add_column(u'ktapp_poll', 'open_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poll.state'
        db.add_column(u'ktapp_poll', 'state',
                      self.gf('django.db.models.fields.CharField')(default='W', max_length=1),
                      keep_default=False)

        # Adding field 'Poll.number_of_comments'
        db.add_column(u'ktapp_poll', 'number_of_comments',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Poll.number_of_votes'
        db.add_column(u'ktapp_poll', 'number_of_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Poll.number_of_people'
        db.add_column(u'ktapp_poll', 'number_of_people',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'PollVote', fields ['user', 'pollchoice']
        db.delete_unique(u'ktapp_pollvote', ['user_id', 'pollchoice_id'])

        # Deleting model 'PollChoice'
        db.delete_table(u'ktapp_pollchoice')

        # Deleting model 'PollVote'
        db.delete_table(u'ktapp_pollvote')

        # Deleting field 'Poll.created_by'
        db.delete_column(u'ktapp_poll', 'created_by_id')

        # Deleting field 'Poll.created_at'
        db.delete_column(u'ktapp_poll', 'created_at')

        # Deleting field 'Poll.nominated_by'
        db.delete_column(u'ktapp_poll', 'nominated_by')

        # Deleting field 'Poll.open_from'
        db.delete_column(u'ktapp_poll', 'open_from')

        # Deleting field 'Poll.open_until'
        db.delete_column(u'ktapp_poll', 'open_until')

        # Deleting field 'Poll.state'
        db.delete_column(u'ktapp_poll', 'state')

        # Deleting field 'Poll.number_of_comments'
        db.delete_column(u'ktapp_poll', 'number_of_comments')

        # Deleting field 'Poll.number_of_votes'
        db.delete_column(u'ktapp_poll', 'number_of_votes')

        # Deleting field 'Poll.number_of_people'
        db.delete_column(u'ktapp_poll', 'number_of_people')
    ...
    models = {
        ...
        u'ktapp.poll': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nominated_by': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'number_of_comments': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'number_of_people': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'number_of_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'open_from': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'open_until': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'W'", 'max_length': '1'}),
        ...
        u'ktapp.pollchoice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_of_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ktapp.Poll']"})
        },
        u'ktapp.pollvote': {
            'Meta': {'unique_together': "(['user', 'pollchoice'],)", 'object_name': 'PollVote'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pollchoice': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ktapp.PollChoice']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ktapp.KTUser']", 'null': 'True', 'blank': 'True'})
        },
        u'ktapp.premier': {
