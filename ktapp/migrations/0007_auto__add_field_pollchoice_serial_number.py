...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PollChoice.serial_number'
        db.add_column(u'ktapp_pollchoice', 'serial_number',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PollChoice.serial_number'
        db.delete_column(u'ktapp_pollchoice', 'serial_number')
