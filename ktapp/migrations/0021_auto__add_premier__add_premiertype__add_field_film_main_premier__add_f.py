...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.main_premier'
        db.add_column(u'ktapp_film', 'main_premier',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Film.main_premier_year'
        db.add_column(u'ktapp_film', 'main_premier_year',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.main_premier'
        db.delete_column(u'ktapp_film', 'main_premier')

        # Deleting field 'Film.main_premier_year'
        db.delete_column(u'ktapp_film', 'main_premier_year')
