...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.number_of_trivias'
        db.add_column(u'ktapp_film', 'number_of_trivias',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.number_of_trivias'
        db.delete_column(u'ktapp_film', 'number_of_trivias')
