...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.number_of_reviews'
        db.add_column(u'ktapp_film', 'number_of_reviews',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.number_of_reviews'
        db.delete_column(u'ktapp_film', 'number_of_reviews')
