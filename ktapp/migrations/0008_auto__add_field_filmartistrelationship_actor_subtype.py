...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilmArtistRelationship.actor_subtype'
        db.add_column(u'ktapp_filmartistrelationship', 'actor_subtype',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilmArtistRelationship.actor_subtype'
        db.delete_column(u'ktapp_filmartistrelationship', 'actor_subtype')
