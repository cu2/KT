...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.number_of_comments'
        db.add_column(u'ktapp_film', 'number_of_comments',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.number_of_comments'
        db.delete_column(u'ktapp_film', 'number_of_comments')
