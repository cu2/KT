...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.number_of_awards'
        db.add_column(u'ktapp_film', 'number_of_awards',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Film.number_of_awards'
        db.delete_column(u'ktapp_film', 'number_of_awards')
