...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # self.update_keyword_segment_all(cursor, 'genre')
        ...
        # self.update_keyword_segment_all(cursor, 'country')
        ...
        # self.update_keyword_usersegment_all(cursor, 'genre')
        # for keyword in models.Keyword.objects.filter(keyword_type=models.Keyword.KEYWORD_TYPE_COUNTRY):
        #     self.update_keyword_usersegment(cursor, 'country', keyword.id)
        # self.update_keyword_usersegment_all(cursor, 'country')
    ...
    def update_keyword_segment_all(self, cursor, dimension):
        self.stdout.write('Keyword segment %s:all...' % dimension)
        cursor.execute('''
    ...
    def update_keyword_usersegment_all(self, cursor, dimension):
        self.stdout.write('Keyword usersegment %s:all...' % dimension)
        cursor.execute('''
            UPDATE ktapp_userprofilesegment ups
            INNER JOIN (
